...
const ConfirmarParticipacaoTokenRoute =
  ConfirmarParticipacaoTokenRouteImport.update({
    id: '/confirmar-participacao/$token',
    path: '/confirmar-participacao/$token',
    getParentRoute: () => rootRouteImport,
  } as any)
...
const ApiSupportAttachmentsUploadRoute =
  ApiSupportAttachmentsUploadRouteImport.update({
    id: '/api/support-attachments/upload',
    path: '/api/support-attachments/upload',
    getParentRoute: () => rootRouteImport,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/confirmar-participacao/$token': {
      id: '/confirmar-participacao/$token'
      path: '/confirmar-participacao/$token'
      fullPath: '/confirmar-participacao/$token'
      preLoaderRoute: typeof ConfirmarParticipacaoTokenRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/projetos/': {
      id: '/projetos/'
    ...
    '/api/support-attachments/$id': {
      id: '/api/support-attachments/$id'
      path: '/api/support-attachments/$id'
      fullPath: '/api/support-attachments/$id'
      preLoaderRoute: typeof ApiSupportAttachmentsIdRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/support-attachments/upload': {
      id: '/api/support-attachments/upload'
      path: '/api/support-attachments/upload'
      fullPath: '/api/support-attachments/upload'
      preLoaderRoute: typeof ApiSupportAttachmentsUploadRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/projetos/$id/': {
      id: '/projetos/$id/'
