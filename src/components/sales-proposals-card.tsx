...
export function SalesProposalsCard({ projectId }: { projectId: string }) {
  ...
  const hasCounteroffers = proposals.some((proposal) => proposal.counterofferValue !== undefined);
            ...
            <form
              ...
              onSubmit={async (event) => {
                ...
                try {
                  ...
                  showValidationAlert(
                    error,
                    "Não foi possível salvar a proposta. Revise os campos informados.",
                  );
                }
              }}
            >
          ...
          <table className="w-full min-w-[960px] table-fixed text-sm">
            <thead className="bg-muted/50 text-left text-xs uppercase tracking-wide text-muted-foreground">
              <tr>
                ...
                {hasCounteroffers && (
                  <th className="w-[15%] px-2 py-3 text-right leading-tight">
            ...
            <tbody className="divide-y">
              {proposals.map((proposal) => (
                <tr key={proposal.id}>
                  ...
                  <td className="px-2 py-3 text-right font-semibold tabular-nums">
                    {proposal.finalSaleValue !== undefined
                      ? formatBRL(proposal.finalSaleValue)
                      : "—"}
                  </td>
            ...
            <dl className="grid gap-4 text-sm sm:grid-cols-2">
              ...
              {viewProposal.counterofferValue !== undefined && (
                <Detail
                  ...
                  value={formatBRL(viewProposal.counterofferValue)}
                />
              )}
              ...
              {viewProposal.finalSaleValue !== undefined && (
                <Detail
                  ...
                  value={formatBRL(viewProposal.finalSaleValue)}
                />
              )}
