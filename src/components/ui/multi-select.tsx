          ...
          {selected.map((value) => {
            ...
            return (
              ...
              >
                {option?.label}{" "}
                {option?.type && (
                  <span className="text-[10px] ml-1 opacity-70">({option.type})</span>
                )}
                <button
                  type="button"
                ...
                {selectables.map((option) => {
                  return (
                    <CommandItem
                      ...
                      className="min-h-11 whitespace-normal [overflow-wrap:anywhere] cursor-pointer"
                    >
                      {option.label}{" "}
                      {option.type && (
                        <span className="text-[10px] ml-2 opacity-50">({option.type})</span>
                      )}
                    </CommandItem>
                  );
                })}
